...
\newcommand{\spicecolor}{\color[rgb]{0.94, 1.0, 1.0}} % Azure (web) Azure mist
...
\lstdefinestyle{SPICE}{language=SPICE,backgroundcolor=\spicecolor}
...
\newcommand{\bug}{\includegraphics[height=10ex]{fig/iconbug.png}}
...
% multilanguage using hint described at
% http://tex.stackexchange.com/questions/5076/is-it-possible-to-keep-my-translation-together-with-original-text
\newcommand{\setdoclang}[2]
{
    \def\doclangshort{#1}
    \def\doclang{#2}
}
\setdoclang{en}{english} % default lang
\newcommand{\langif}[3]
{
...
\newcommand{\ru}[1]{\lang{ru}{#1}}
\newcommand{\sectionlang}[2]{\lang{#1}{\section{#2}}}

% relative sectioning hint described at
% http://stackoverflow.com/questions/2066119/relative-section-specification
\newcounter{relsecount}
\setcounter{relsecount}{0}
\newcommand{\secup}{\addtocounter{relsecount}{1}}
\newcommand{\secdown}{\addtocounter{relsecount}{-1}}
\newcommand{\secthis}[1]{
	\ifthenelse{\equal{\value{relsecount}}{0}}{\part{#1}}{}
	\ifthenelse{\equal{\value{relsecount}}{-1}}{\chapter{#1}}{}
	\ifthenelse{\equal{\value{relsecount}}{-2}}{\section{#1}}{}
	\ifthenelse{\equal{\value{relsecount}}{-3}}{\subsection{#1}}{}
	\ifthenelse{\equal{\value{relsecount}}{-4}}{\subsubsection{#1}}{}
}
\newcommand{\secen}[1]{
	\ifthenelse{\equal{\doclangshort}{en}}{\secthis{#1}}{}
}
\newcommand{\secru}[1]{
	\ifthenelse{\equal{\doclangshort}{ru}}{\secthis{#1}}{}
}
